...
from .views import file_upload, IndexView, NewsListView, PlayerSearch, TournamentSearch, CalendarCreateView , CalendarUpdateView , CalendarDeleteView, ClubsListView
