...
from webapp.models import Player, City, Country


class TournamentTestsForUnregisterUser(TestCase):  # Для анонимных пользователейзне
    @classmethod
    def setUpTestData(cls):  # Создаём тестировочные данные
        ...
        country = Player.objects.create(country_code='kg')
        city_1 = City.objects.create(city='Test_city', country=country)
